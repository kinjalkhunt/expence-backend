...
export const addOutExpense = async (req, res) => {
    ...
    //   const billUrl = billFile ? `/uploads/bills/${billFile.filename}` : undefined;
...
export const GetPayment = async (req, res) => {
    try {
        ...
        const cachedData = await redis.get("outExpenses");
        ...
        await redis.set("outExpenses", JSON.stringify(expenses), { EX: 3600 });
